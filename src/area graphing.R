setwd("F:/UCSB/Masters_Thesis/Figures and Tables/Change Statistics")
...
graph <- ggplot(area, aes(fill=Landcover, y=Area, x=Date)) +
  ...
  labs(title="Landcover Area",y="Percent Cover (%)",x="Date")+
  scale_fill_manual(values = colors)

graph + 
  theme(plot.title = element_text(size=20, face="bold", hjust=.5),axis.text.x=element_text(size=9,face="italic"))
ggsave("stacked_bar_area.eps", path = "F:/UCSB/Masters_Thesis/Figures and Tables/Change Statistics")
...
ggsave("area_difference_plot.png", path = "F:/UCSB/Masters_Thesis/Figures and Tables/Change Statistics")
